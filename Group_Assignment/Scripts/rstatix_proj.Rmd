...
effect_one <- penguins %>% 
  cohens_d(bill_length_mm ~ 1, mu = 0)
effect_one
...
-   Peason's correlation: a linear description between the variables (parametric)
...
Values range between -1 and 1. Negative values (-1 to 0) mean that there is a negative association between the variables. Positive values (0 to 1) mean that there is positive association between the variables. 
...
view(cormatpens)
```
>>>>>>> 652864c599d6a97a7a3d444c0aff540e4d1477d1
